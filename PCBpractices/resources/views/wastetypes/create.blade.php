        ...
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('wastetypes.store') }}" class="form-horizontal">
                        @csrf
                        <div class="form-group">
                            <label>Waste Type Name</label>
                            <input type="text" name="EntityName" value="" class="form-control" placeholder="Enter Waste Type Name" required="">
                            @error('EntityName')
