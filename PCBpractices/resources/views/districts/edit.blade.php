        ...
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('districts.update',$editdistrict->DistrictId) }}" method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="DistrictName" value="{{ $editdistrict->DistrictName }}"  class="form-control" placeholder="Enter District Name" required="">
                            @error('DistrictName')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
