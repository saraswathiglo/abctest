...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    <p class="card-title">Edit State</p>
                    @if (session('success'))
                    ...
                    @endif
                    <form action="{{ route('states.update',$editstate->StateId) }}" method="POST">
                    @csrf
                    @method('PUT')
                        <div class="form-group">
                            <label>State Name</label>
                            <input type="text" name="StateName" value="{{ $editstate->StateName }}" class="form-control" placeholder="Enter State Name" required="">
                            @error('StateName')
