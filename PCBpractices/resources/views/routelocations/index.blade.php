            ...
            <div class="col-md-12 grid-margin">
                <div class="d-flex justify-content-between flex-wrap">
                    ...
                    <div class="d-flex justify-content-between align-items-end flex-wrap">
                        <a href="{{ url('routelocation/create') }}">
                            ...
                            <table id="recent-purchases-listing" class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Route Name</th>
                                        <th>Start Point</th>
                                        <th>Start Point Latitude, Longitude</th>
                                        <th>End Point</th>
                                        <th>End Point Latitude, Longitude</th>
                                        <th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $route->StartPointLatitude }}, {{ $route->StartPointLongitude }}</td>
                                        <td>{{ $route->EndPoint }}</td>
                                        <td>{{ $route->EndPointLatitude }} , {{ $route->EndPointLongitude }}</td>
                                        <td>
                                            ...
                                            <a href="{{ route('routelocation.edit',$route->RouteId) }}" class="btn btn-warning btn-sm" title="EDIT">
                                                <span class="mdi mdi-tooltip-edit"></span>
                                            </a>
                                            <!-- <form action="{{ route('routelocation.destroy',$route->RouteId) }}" method="POST">
                                            @method('DELETE')
                                            @csrf
