...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    <p class="card-title">Edit Role</p>
                    @if (session('success'))
                    ...
                    @endif
                    <form action="{{ route('roles.update',$editrole->RoleId) }}" method="POST">
                    @csrf
                    @method('PUT')
                        <div class="form-group">
                            <label>Role Name</label>
                            <input type="text" name="RoleName" value="{{ $editrole->RoleName }}"  class="form-control" placeholder="Enter Role Name" required="">
                            @error('RoleName')
