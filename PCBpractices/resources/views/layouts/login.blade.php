...
{{--    <link href="{{ asset('css/style.css') }}" rel="stylesheet">--}}
    <style>
        ...
        .main-bg::after{
            ...
            right: -119px;
            top: -93px;
            background-color: rgba(255, 117, 41, 0.29);
            width: 466px;
            height: 595px;
        ...
        @-webkit-keyframes ripple {
            0% {
                box-shadow: 0 0 0 0 rgba(255, 117, 41, 0.49), 0 0 0 1em rgba(255, 117, 41, 0.49), 0 0 0 3em rgba(255, 117, 41, 0.49), 0 0 0 5em rgba(255, 117, 41, 0.49);
            }
            100% {
                box-shadow: 0 0 0 1em rgba(255, 117, 41, 0.49), 0 0 0 3em rgba(255, 117, 41, 0.49), 0 0 0 5em rgba(255, 117, 41, 0.49), 0 0 0 8em rgba(175, 166, 255, 0);
            }
        }
        @keyframes ripple {
            0% {
