        ...
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('driverroutes.store') }}" class="form-horizontal">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form_date" name="DriverRouteFromDate" id="DriverRouteFromDate" placeholder="Driver to the route From Date" autocomplete="off" required="" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form_time" name="DriverRouteFromTime" id="DriverRouteFromTime" placeholder="Driver to the route From Date" autocomplete="off" required="" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control to_date" name="DriverRouteToDate" id="DriverRouteToDate" placeholder="To Date" autocomplete="off"/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control to_time" name="DriverRouteToTime" id="DriverRouteToTime" placeholder="Driver to the route From Date" autocomplete="off" required="" />
