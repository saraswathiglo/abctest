            ...
            <div class="content-wrapper">
                        ...
                        <div class="d-flex justify-content-between flex-wrap">
                            <div class="d-flex align-items-end flex-wrap">
                                <div class="mr-md-3 mr-xl-5">
                                    <h3>Recycle Plant Branches</h3>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between align-items-end flex-wrap">
                                <a href="{{ url('addrecycleplantbranch') }}">
                                    <button type="button" class="btn btn-light bg-white btn-icon mr-3 mt-2 mt-xl-0">
                                        <i class="mdi mdi-plus text-muted"></i>
                                    </button>
                                </a>
                                <a href="{{ url('addrecycleplantbranch') }}">
                                    <button class="btn btn-primary mt-2 mt-xl-0">Add Recycle Plant Branch</button>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <p class="card-title">Recycle Plant Branches</p>
                                <div class="table-responsive">
                                    <table id="recent-purchases-listing" class="table">
                                        <thead>
                                            <tr>
                                                <th>S.No.</th>
                                                <th>Recycle Plant Name</th>
                                                <th>Branch Name</th>
                                                <th>Phone Number</th>
                                                <th>Email Id</th>
                                                <th>Address</th>
